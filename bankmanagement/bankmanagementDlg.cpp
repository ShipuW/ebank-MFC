...
// bankmanagementDlg.cpp : 实现文件
//

#include "stdafx.h"
#include "bankmanagement.h"
#include "bankmanagementDlg.h"
...
CbankmanagementDlg::CbankmanagementDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CbankmanagementDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CbankmanagementDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CbankmanagementDlg::OnBnClickedOk)
END_MESSAGE_MAP()
...
void CbankmanagementDlg::OnPaint()
{
	...
	else
	{
		...
		bmpBackground.LoadBitmapA(IDB_BACKGROUND);
		BITMAP bitmap;
...
void CbankmanagementDlg::OnBnClickedOk()
{	
	MessageBox("s");
	// TODO:  在此添加控件通知处理程序代码
	CDialogEx::OnOK();
