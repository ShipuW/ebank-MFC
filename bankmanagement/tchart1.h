...
enum
{
    EShapeLayout_DUMMY = 0
}EShapeLayout;
enum
{
    sqHigh = 0,
    sqLow = 1
}ECanvasStretchQuality;
enum
{
    asStopped = 0,
    asPlaying = 1,
...
//
	...
	{
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0xea, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Left, Top, Right, Bottom);
	}
	LPDISPATCH get_Animate()
	{
		LPDISPATCH result;
		InvokeHelper(0xeb, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
